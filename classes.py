...
class Level:
    ...
    def run(self) -> None:
        self.update()
        self.draw()
        print(self.sprite_group_projeteis)
    ...
    def __init__(self, pos: tuple, life: int, face_right, sprite_group_personagens, sprite_group_projeteis) -> None:
        ...
        sprite_sheet_death = SpriteSheet(
            ...
            [
                ...
                (256, 0, 64, 64), (320, 0, 64, 64),
                (384, 0, 64, 64), (448, 0, 64, 64),
                (512, 0, 64, 64), (576, 0, 64, 64),
                (640, 0, 64, 64), (704, 0, 64, 64),
                (768, 0, 64, 64), (832, 0, 64, 64),
                (896, 0, 64, 64), (960, 0, 64, 64),
                (1024, 0, 64, 64), (1088, 0, 64, 64), (1152, 0, 64, 64),
                (1216, 0, 64, 64), (1280, 0, 64, 64), (1344, 0, 64, 64),
                (1408, 0, 64, 64), (1472, 0, 64, 64), (1536, 0, 64, 64)
            ]
        )
